...
export const FORMATS: FormatDef[] = [
  ...
  },
  {
    ...
    notes: 'Reading covers the compressions GDAL and QGIS produce by default. Overviews, masks and multi-IFD pyramids are not read: only the first image of the file.',
  },
  {
    id: 'worldfile',
    name: 'World file',
